...
def cmdLineParse():
    ...
    parser.add_argument('-b', type=float, nargs=4, dest='roi', required=False,
                        metavar=('S', 'N', 'W', 'E'),
    ...
    parser.add_argument('-a', type=int, dest='alooks', required=False,
                        help='Azimuthlooks')
    parser.add_argument('-r', type=int, dest='rlooks', required=False,
                        help='Rangelooks')
    parser.add_argument('-f', type=float, dest='filtstrength', required=False,
