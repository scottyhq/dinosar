...
def cmdLineParse():
    ...
    parser.add_argument('-t', type=str, dest='template', required=True,
    ...
    parser.add_argument('-o', type=str, dest='orbitdir', required=False,
                        help='orbit directory on EFS')
    parser.add_argument('-d', type=str, dest='dem', required=False,
                        help='DEM file path on EFS')
    parser.add_argument('-r', type=str, dest='rawdir', required=False,
                        help='raw data path on EFS')
