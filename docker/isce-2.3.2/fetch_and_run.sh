...
# Borrowed from https://github.com/FredHutch/url-fetch-and-run/blob/master/fetch-and-run/fetch_and_run.sh
...
# Run via login shell to pick up PATH set in Dockerfile
